...
# body param
SchemaForRequestBodyApplicationJson = BatchGetRequest


request_body_batch_get_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _source_batch_get_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_batch_get_request.serialize(body, content_type)
...
class SourceBatchGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def source_batch_get(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def source_batch_get(
        ...
        return self._source_batch_get_oapg(
            body=body,

...
class BaseApi(api_client.Api):
    @typing.overload
    def _item_id_forward_batch_translate_oapg(
        self,
...
class ItemIdForwardBatchTranslate(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def item_id_forward_batch_translate(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,list, tuple, ],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def item_id_forward_batch_translate(
        ...
        return self._item_id_forward_batch_translate_oapg(
            body=body,

...
# body param
SchemaForRequestBodyApplicationJson = Graph


request_body_graph = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = schemas.IntSchema
...
class BaseApi(api_client.Api):
    ...
    def _graph_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_graph.serialize(body, content_type)

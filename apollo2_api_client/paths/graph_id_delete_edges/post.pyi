...
request_body_edge = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _graph_id_delete_edges_post_oapg(
        self,
    ...
    def _graph_id_delete_edges_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_edge.serialize(body, content_type)
...
class GraphIdDeleteEdgesPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def graph_id_delete_edges_post(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,list, tuple, ],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def graph_id_delete_edges_post(
        ...
        return self._graph_id_delete_edges_post_oapg(
            body=body,

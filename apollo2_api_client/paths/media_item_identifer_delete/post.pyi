...
class BaseApi(api_client.Api):
    @typing.overload
    def _media_item_identifer_delete_oapg(
        self,
...
class MediaItemIdentiferDelete(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def media_item_identifer_delete(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,list, tuple, ],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def media_item_identifer_delete(
        ...
        return self._media_item_identifer_delete_oapg(
            body=body,

...
class BaseApi(api_client.Api):
    @typing.overload
    def _cluster_id_delete_members_post_oapg(
        self,
...
class ClusterIdDeleteMembersPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def cluster_id_delete_members_post(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,list, tuple, ],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def cluster_id_delete_members_post(
        ...
        return self._cluster_id_delete_members_post_oapg(
            body=body,

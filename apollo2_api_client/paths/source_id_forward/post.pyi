...
class BaseApi(api_client.Api):
    @typing.overload
    def _source_id_forward_batch_translate_oapg(
        self,
...
class SourceIdForwardBatchTranslate(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def source_id_forward_batch_translate(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,list, tuple, ],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def source_id_forward_batch_translate(
        ...
        return self._source_id_forward_batch_translate_oapg(
            body=body,

...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['EnrichmentMeta']:
            return EnrichmentMeta

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['EnrichmentMeta'], typing.List['EnrichmentMeta']],
    ...
    def __getitem__(self, i: int) -> 'EnrichmentMeta':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _enrichments_meta_get_oapg(
        self,
...
class EnrichmentsMetaGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def enrichments_meta_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def enrichments_meta_get(
        ...
        return self._enrichments_meta_get_oapg(

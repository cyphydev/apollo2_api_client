...
import apollo2_api_client.models
from apollo2_api_client import rest
from apollo2_api_client.exceptions import ApiValueError, ApiException
...
class ApiClient(object):
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(apollo2_api_client.models, klass)
    ...
    def call_api(self, resource_path, method,
                 ...
                 async_req=False, _return_http_data_only=None,

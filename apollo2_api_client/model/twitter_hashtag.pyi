...
class TwitterHashtag(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["end", "start", "tag", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["end", "start", "tag", ], str]):

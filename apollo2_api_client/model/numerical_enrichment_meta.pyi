...
class NumericalEnrichmentMeta(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "name", "provider", "tag", "version", "data", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "name", "provider", "tag", "version", "data", "type", ], str]):

...
class ArrayEnrichmentMeta(
    ...
    label_map: MetaOapg.properties.label_map
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["label_map"]) -> MetaOapg.properties.label_map: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "name", "provider", "tag", "version", "label_map", "data", "type", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["label_map"]) -> MetaOapg.properties.label_map: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "name", "provider", "tag", "version", "label_map", "data", "type", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        label_map: typing.Union[MetaOapg.properties.label_map, dict, frozendict.frozendict, ],

...
class Claim(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "provider", "tag", "version", "id", "description", "data", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "provider", "tag", "version", "id", "description", "data", "type", ], str]):

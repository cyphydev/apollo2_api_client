...
class IncasLinks(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["messages", "self", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["messages", "self", ], str]):

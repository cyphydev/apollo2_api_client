...
class NumericalEnrichmentMeta(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NumericalEnrichmentMeta:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NumericalEnrichmentMeta:
        """Create an instance of NumericalEnrichmentMeta from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return NumericalEnrichmentMeta.parse_obj(obj)

        _obj = NumericalEnrichmentMeta.parse_obj({

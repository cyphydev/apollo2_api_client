...
class TwitterData(BaseModel):
    ...
    context_annotations: Optional[List[TwitterContextAnnotation]] = []
    author_id: Optional[StrictStr] = None
    conversation_id: Optional[StrictStr] = None
    created_at: Optional[StrictStr] = None
    edit_controls: Optional[TwitterEditControls] = None
    edit_history_tweet_ids: Optional[List[StrictStr]] = []
    ...
    reference_tweets: Optional[List[TwitterReferencedTweet]] = []

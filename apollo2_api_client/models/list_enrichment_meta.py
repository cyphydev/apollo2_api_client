...
class ListEnrichmentMeta(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListEnrichmentMeta:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListEnrichmentMeta:
        """Create an instance of ListEnrichmentMeta from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListEnrichmentMeta.parse_obj(obj)

        _obj = ListEnrichmentMeta.parse_obj({

...
class TextEnrichment(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TextEnrichment:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TextEnrichment:
        """Create an instance of TextEnrichment from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TextEnrichment.parse_obj(obj)

        _obj = TextEnrichment.parse_obj({
            "name": obj.get("name"),

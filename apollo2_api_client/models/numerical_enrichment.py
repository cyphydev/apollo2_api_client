...
class NumericalEnrichment(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NumericalEnrichment:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NumericalEnrichment:
        """Create an instance of NumericalEnrichment from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return NumericalEnrichment.parse_obj(obj)

        _obj = NumericalEnrichment.parse_obj({
            "name": obj.get("name"),

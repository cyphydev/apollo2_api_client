...
class EnrichmentMeta(BaseModel):
    ...
    anyof_schema_1_validator: Optional[CategoryEnrichmentMeta] = None
    # data type: NumericalEnrichmentMeta
    anyof_schema_2_validator: Optional[NumericalEnrichmentMeta] = None
    # data type: ArrayEnrichmentMeta
    anyof_schema_3_validator: Optional[ArrayEnrichmentMeta] = None
    # data type: TextEnrichmentMeta
    anyof_schema_4_validator: Optional[TextEnrichmentMeta] = None
    # data type: ListEnrichmentMeta
    anyof_schema_5_validator: Optional[ListEnrichmentMeta] = None
    actual_instance: Any
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EnrichmentMeta:

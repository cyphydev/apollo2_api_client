...
class CategoryEnrichmentMeta(BaseModel):
    ...
    categories: List[StrictStr] = Field(..., description="The list of categories for the enrichment.")
    __properties = ["description", "name", "provider", "tag", "version", "data", "type", "categories"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CategoryEnrichmentMeta:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CategoryEnrichmentMeta:
        """Create an instance of CategoryEnrichmentMeta from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CategoryEnrichmentMeta.parse_obj(obj)

        _obj = CategoryEnrichmentMeta.parse_obj({

...
class IncasMessage(BaseModel):
    ...
    """
    annotations: Optional[List[IncasAnnotation]] = []
    data_tags: Optional[List[StrictStr]] = []
    embedded_urls: Optional[List[StrictStr]] = []
    extra_attributes: Optional[List[IncasExtraAttribute]] = []
    image_urls: Optional[List[StrictStr]] = []
    segments: Optional[List[IncasSegment]] = []
    ...
    mentioned_users: Optional[List[Any]] = None

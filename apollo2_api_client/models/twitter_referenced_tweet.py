...
class TwitterReferencedTweet(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TwitterReferencedTweet:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TwitterReferencedTweet:
        """Create an instance of TwitterReferencedTweet from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TwitterReferencedTweet.parse_obj(obj)

        _obj = TwitterReferencedTweet.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type")
        })
        return _obj

...
class RawDataPostEntry(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RawDataPostEntry:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RawDataPostEntry:
        """Create an instance of RawDataPostEntry from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return RawDataPostEntry.parse_obj(obj)

        _obj = RawDataPostEntry.parse_obj({

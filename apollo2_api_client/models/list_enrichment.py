...
class ListEnrichment(BaseModel):
    ...
    value: conlist(ValueInner) = ...
    confidence: Optional[conlist(confloat(le=1.0, ge=0.0, strict=True))] = Field(None, description="The confidence that this enrichment is correct, expressed as a percentage between 0.0 and 1.0")

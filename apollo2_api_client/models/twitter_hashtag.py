...
class TwitterHashtag(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TwitterHashtag:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TwitterHashtag:
        """Create an instance of TwitterHashtag from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TwitterHashtag.parse_obj(obj)

        _obj = TwitterHashtag.parse_obj({
            "end": obj.get("end"),
            "start": obj.get("start"),
            "tag": obj.get("tag")
        })

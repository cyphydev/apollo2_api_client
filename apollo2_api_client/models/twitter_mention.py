...
class TwitterMention(BaseModel):
    ...
    __properties = ["end", "id", "start", "username"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TwitterMention:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TwitterMention:
        """Create an instance of TwitterMention from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TwitterMention.parse_obj(obj)

        _obj = TwitterMention.parse_obj({
            "end": obj.get("end"),
            "id": obj.get("id"),
            "start": obj.get("start"),

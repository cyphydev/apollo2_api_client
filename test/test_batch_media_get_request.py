...
from mips_api_client.models.batch_media_get_request import BatchMediaGetRequest  # noqa: E501
...
class TestBatchMediaGetRequest(unittest.TestCase):
    ...
    def testBatchMediaGetRequest(self):
        ...
        # model = mips_api_client.models.batch_media_get_request.BatchMediaGetRequest()  # noqa: E501
        pass

...
class SourceApi(object):
    ...
    def source_tag_name_delete(self, tag_name, **kwargs):  # noqa: E501
        """Source Tag Name Delete  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.source_tag_name_delete(tag_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.source_tag_name_delete_with_http_info(tag_name, **kwargs)  # noqa: E501
        else:
            (data) = self.source_tag_name_delete_with_http_info(tag_name, **kwargs)  # noqa: E501
            return data

    def source_tag_name_delete_with_http_info(self, tag_name, **kwargs):  # noqa: E501
        """Source Tag Name Delete  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.source_tag_name_delete_with_http_info(tag_name, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method source_tag_name_delete" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'tag_name' is set
        if ('tag_name' not in params or
                params['tag_name'] is None):
            raise ValueError("Missing the required parameter `tag_name` when calling `source_tag_name_delete`")  # noqa: E501

...
class MediaItemApi(object):
    ...
    def media_item_tag_name_delete(self, tag_name, **kwargs):  # noqa: E501
        """Media Item Tag Name Delete  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.media_item_tag_name_delete(tag_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.media_item_tag_name_delete_with_http_info(tag_name, **kwargs)  # noqa: E501
        else:
            (data) = self.media_item_tag_name_delete_with_http_info(tag_name, **kwargs)  # noqa: E501
            return data

    def media_item_tag_name_delete_with_http_info(self, tag_name, **kwargs):  # noqa: E501
        """Media Item Tag Name Delete  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.media_item_tag_name_delete_with_http_info(tag_name, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method media_item_tag_name_delete" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'tag_name' is set
        if ('tag_name' not in params or
                params['tag_name'] is None):
            raise ValueError("Missing the required parameter `tag_name` when calling `media_item_tag_name_delete`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/media_item/tag_name/delete', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def media_item_tag_node_id_get(self, id, **kwargs):  # noqa: E501
        """Media Item Tag Node Id Get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.media_item_tag_node_id_get(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.media_item_tag_node_id_get_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.media_item_tag_node_id_get_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def media_item_tag_node_id_get_with_http_info(self, id, **kwargs):  # noqa: E501
        """Media Item Tag Node Id Get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.media_item_tag_node_id_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method media_item_tag_node_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `media_item_tag_node_id_get`")  # noqa: E501

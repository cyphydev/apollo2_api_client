...
class Claim(object):
    ...
    @property
    def name(self):
        """Gets the name of this Claim.  # noqa: E501

        The enrichment (e.g., Concern-Stance) name for the enrichment.  # noqa: E501

        :return: The name of this Claim.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @property
    def provider(self):
        """Gets the provider of this Claim.  # noqa: E501

        The team (e.g., UIUC-DMG) who provides the enrichment.  # noqa: E501

        :return: The provider of this Claim.  # noqa: E501
        :rtype: str
        """
    ...
    def provider(self, provider):
        ...
        :param provider: The provider of this Claim.  # noqa: E501
        :type: str
        """
        if provider is None:
    ...
    @property
    def tag(self):
        """Gets the tag of this Claim.  # noqa: E501

        The tag within the same (provider, name).  # noqa: E501

        :return: The tag of this Claim.  # noqa: E501
        :rtype: str
        """
        return self._tag
    ...
    @tag.setter
    def tag(self, tag):
        """Sets the tag of this Claim.

        The tag within the same (provider, name).  # noqa: E501

        :param tag: The tag of this Claim.  # noqa: E501
        :type: str
        """
        if tag is None:
    ...
    @property
    def version(self):
        """Gets the version of this Claim.  # noqa: E501

        The version within the same (provider, name).  # noqa: E501

        :return: The version of this Claim.  # noqa: E501
        :rtype: str
        """
    ...
    def version(self, version):
        """Sets the version of this Claim.

        The version within the same (provider, name).  # noqa: E501

        :param version: The version of this Claim.  # noqa: E501
        :type: str
        """
        if version is None:
    ...
    def description(self):
        """Gets the description of this Claim.  # noqa: E501


        :return: The description of this Claim.  # noqa: E501
        :rtype: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this Claim.  # noqa: E501


        :return: The type of this Claim.  # noqa: E501
        :rtype: ClusterType
        """
        return self._type

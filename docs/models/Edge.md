# apollo2_api_client.model.edge.Edge
...
------------ | ------------- | ------------- | ------------- | -------------
**src_id** | decimal.Decimal, int,  | decimal.Decimal,  |  | 
**dst_id** | decimal.Decimal, int,  | decimal.Decimal,  |  | 
**graph_id** | decimal.Decimal, int,  | decimal.Decimal,  |  | 
**type** | str,  | str,  |  | 

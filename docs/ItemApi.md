...
# **item_count_get**
> int item_count_get(last=last, end=end, platform=platform)
...
try:
    # Item Count Get
    api_response = api_instance.item_count_get(last=last, end=end, platform=platform)
    pprint(api_response)
except ApiException as e:
...
# **item_max_id_get**
> int item_max_id_get(platform=platform)
...
try:
    # Item Max Id Get
    api_response = api_instance.item_max_id_get(platform=platform)
    pprint(api_response)
except ApiException as e:
